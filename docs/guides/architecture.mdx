...
:::info
The accepted [runtime parity decision](/guides/runtime-parity) makes this boundary explicit: inherited defects are recorded before divergence, upstream correction is preferred, and every local exception must be narrow, justified, and regression-tested.
:::
...
<Tree>
  ...
  <Tree.Folder name="distilled-spec-avalara">
    ...
    <Tree.Folder name="distilled-avalara">
      <Tree.File name="provider policy + generated operations" />
    </Tree.Folder>
  </Tree.Folder>
  ...
  <Tree.Folder name="distilled-spec-opensearch">
    ...
    <Tree.Folder name="distilled-opensearch">
      <Tree.File name="cluster policy + 684 generated operations" />
    </Tree.Folder>
  </Tree.Folder>
</Tree>
