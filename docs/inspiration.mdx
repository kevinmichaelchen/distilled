...
Architecture alignment is governed by [ADR-001](/guides/protocol-architecture): the shared engine and provider Protocol layers follow Alchemy's current operation model, while provider-neutral additions require focused tests.
